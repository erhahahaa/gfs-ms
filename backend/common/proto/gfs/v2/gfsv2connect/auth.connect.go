...
const (
	...
	AuthServiceName = "gfs.v2.AuthService"
)
...
const (
	...
	AuthServiceLoginProcedure = "/gfs.v2.AuthService/Login"
	// AuthServiceRegisterProcedure is the fully-qualified name of the AuthService's Register RPC.
	AuthServiceRegisterProcedure = "/gfs.v2.AuthService/Register"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	authServiceServiceDescriptor        = v2.File_gfs_v2_auth_proto.Services().ByName("AuthService")
...
func NewAuthServiceHandler(svc AuthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/gfs.v2.AuthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
